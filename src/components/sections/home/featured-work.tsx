  ...
  return (
    <section id="work" className="bg-muted/30 py-14 sm:py-16 lg:py-20">
      <div className="container mx-auto px-5 sm:px-6 lg:px-8">
        ...
        <article className="mx-auto max-w-4xl rounded-xl border bg-card p-7 sm:p-9">
          ...
          <p className="mt-4 max-w-2xl text-muted-foreground">
            A technology platform supporting preparedness and emergency response
            through mobile technology, geofencing, location-based services, and
